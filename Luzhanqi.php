...
<html>
	...
	<body>
		...
		<div class="info">
			...
			<br>
			<button id="save" type="button" onclick="save(this)">SAVE GAME</button>
			<br>
			...
			<div class="enemy 1" id="E1-1">敵</div>
			<div class="enemy 1" id="E1-2">敵</div>
			<div class="enemy 1" id="E1-3">敵</div>
			<div class="enemy 2" id="E2-1">敵</div>
			<div class="enemy 2" id="E2-2">敵</div>
			<div class="enemy 2" id="E2-3">敵</div>
			<div class="enemy 3" id="E3-1">敵</div>
			<div class="enemy 3" id="E3-2">敵</div>
			<div class="enemy 3" id="E3-3">敵</div>
			<div class="enemy 4" id="E4-1">敵</div>
			<div class="enemy 4" id="E4-2">敵</div>
			<div class="enemy 5" id="E5-1">敵</div>
			<div class="enemy 5" id="E5-2">敵</div>
			<div class="enemy 6" id="E6-1">敵</div>
			<div class="enemy 6" id="E6-2">敵</div>
			<div class="enemy 7" id="E7-1">敵</div>
			<div class="enemy 7" id="E7-2">敵</div>
			<div class="enemy 8" id="E8-1">敵</div>
			<div class="enemy 9" id="E9-1">敵</div>
			<div class="enemy M" id="EM-1">敵</div>
			<div class="enemy M" id="EM-2">敵</div>
			<div class="enemy M" id="EM-3">敵</div>
			<div class="enemy B" id="EB-1">敵</div>
			<div class="enemy B" id="EB-2">敵</div>
			<div class="enemy F" id="EF-1">敵</div>
		</div>
		...
		<script type="text/javascript">			
			//ajax jquert javascript css html php
			//missing S/L game? + testing
			var gameStart = 0;
			var gameTurn = 1;
			...
			function save(el){
				var list = "";
				$('div.pawn,div.enemy').each(function(){
					list += ""+($(this).attr('id'))+" "+($(this).parent().attr('id'))+" ";
				});
				$.get("writeSave.php", { content: list});
				$( "#msg" ).html("Game saved!");
				$( "#log" ).after("Game saved!<br><br>");
			}
			...
			function updateGame(data){
				if (gameTurn == 2){
					...
					if(strList[0] == '2'){
						...
						$('div.pawn').draggable({disabled:false});
			...
			function start(el) {
				...
				//send data
				var list = "";
				$('div.pawn').each(function(){
					list += ""+($(this).attr('id'))+" "+($(this).parent().attr('id'))+" ";
				});
				
				$.get("writeP1.php", { content: list});
				//receive data
			...
			function drop(draggedUI,droppedID) {
				...
				if (gameStart == 0){//player setting up	
					...
					c = "1 "+data+" "+y+x+" "+remainingChess+" "+y2+x2;
					$.get("writeLzq.php", { content: c});
					
					//disable draggable until next turn
					$('div.pawn').draggable({disabled:true});
				...
				for (var i = 7; i < 13; i++) {
					for(var k = 0; k < 5; k++){
						...
						if(i == 12 && k == 3){ //put flag here
							document.getElementById("123").appendChild(selector.get("24"));
							map[12][3] = selector.get("24").classList[1];
							locat[12][3] = selector.get("24").id;
							continue;
						}
